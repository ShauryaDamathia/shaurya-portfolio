          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-slate-400">
                If you’d like to collaborate, discuss a project, or just exchange ideas about tech and AI, I’d love to hear from you.<br></br>
                <strong>Let’s connect — or maybe even play a friendly game of chess!</strong>
              </p>
            </div>
